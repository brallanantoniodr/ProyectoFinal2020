...
import { loadpersonaolancho } from '../redux/reducers/cards/personaactions';
...
class personaHolderRaw extends Component {
    ...
    render() {
        let _renderedpersona = this.props.persona.map(
            ...
            return ( <section >
                <h1 style={{marginTop:70, textAlign:"center", fontSize:40, marginBottom:-40}}>Departamento de Olancho</h1>
                <AddpersonaForm / >
                <Stats/>
                  <hr / >
